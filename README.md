...
run: `git clone https://github.com/shakerAbuDrais/diagram-database/`
...
Feel free to check the [issues page](https://github.com/shakerAbuDrais/diagram-database/issues).
